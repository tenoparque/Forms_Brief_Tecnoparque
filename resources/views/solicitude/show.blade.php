                    ...
                    <div class="row">
                        <div class="">
                            <div class="containerProgressBar"
                                style="width: 95%; margin-left: 28px; margin-block-end: 50px; margin-block-end: 5%">
                                <ul class="progressbar">
                                    @foreach ($estados as $estado)
                                        <li
                                            class="{{ $estado->orden_mostrado <= $estadoActual->orden_mostrado ? 'active' : '' }} {{ $estado->nombre }}">
                                            <span>{{ $estado->nombre }}</span>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        @foreach ($datosPorSolicitud as $dato)
                            <div class="">
                                <label style="cursor: initial; outline: none; width: 95%;"></label>
                            </div>

                            <div class="row">
                                <div class="">
                                    <div class="containerProgressBar"
                                        style=" width:95%; margin-left: 28px; margin-block-end: 50px">
                                        <ul class="progressbar" style="">
                                            @foreach ($estados as $estado)
                                                <li
                                                    class="{{ $estado->orden_mostrado <= $estadoActual->orden_mostrado ? 'active' : '' }}">
                    ...
                    <div class="card-body">
                        <div class="table-responsive"
                            ...
                            <table class="table table-bordered table-hover"
                                ...
                                <tbody class="alldata">
                                    <tr class="table-light" style="border-color:transparent">
                                        <td style="text-align: center">{{ $solicitude->tiposdesolicitude->nombre }}</td>
                                        <td style="text-align: center">{{ $solicitude->fecha_y_hora_de_la_solicitud }}
                                        </td>
                                        <td style="text-align: center">{{ $solicitude->user->name }}</td>
                                        <td style="text-align: center">{{ $solicitude->user->nodo->nombre }}</td>
                                        <td style="text-align: center">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if ($historial->isNotEmpty())
                                            ...
                                            <button
                                                ...
                                                data-target="#historialModal">
                                                Ver historial
                                                <i class="fa-solid fa-clock-rotate-left fa-sm"
                                                    style="color: #642c78;"></i>
                                                </a></button>
                                        @else
                                            <p>No hay historial de modificaciones</p>
                                        @endif
                        ...
                        <div class="row">
                            @foreach ($datosPorSolicitud as $dato)
                                <div class="">
                                    <label
                                        style="cursor: initial; outline: none; width: 95%; height:20px; margin-bottom: 10px; margin-top:8px; word-wrap: break-word; overflow-wrap: break-word;"><strong>{{ $dato->titulo }}:</strong></label>
