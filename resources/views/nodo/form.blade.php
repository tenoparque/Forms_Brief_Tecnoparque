<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('nombre', $nodo->nombre, ['class' => 'form-control' . ($errors->has('nombre') ? ' is-invalid' : ''), 'placeholder' => 'Nombre', 'style' => 'width: 85%; border-radius: 50px; border-style: solid; border-width:4px; height:45px;  border-color: #ececec; background-color:  #ececec; margin-bottom: 10px;']) }}
        ...
        @if (Route::currentRouteName() === 'nodos.edit')
            <div class="form-group">
                ...
                <div style="position: relative; width: 100%;">
                    ...
                    <div class="icono" style="right: 16%;">
