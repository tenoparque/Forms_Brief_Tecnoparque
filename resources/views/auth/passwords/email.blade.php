        ...
        <div class="line__email-pass">
            <div class="flex-direction">
                    ...
                    <form class="form-resetPass" method="POST" action="{{ route('password.email') }}">   
                        ...
                        @csrf
                            ...
                            <div class="form__section-resetPass"> 
                                ...
                                <input placeholder="Correo electrónico" id="email" type="email"class="form-control @error('email')   is-invalid @enderror form_inputResetPass"
                    ...
                    <div class="form__img-resetPass">
                        ...
                        <div class="title__form-resetPass">{{ __('Restablecer contraseña') }}</div>
                    </div>
