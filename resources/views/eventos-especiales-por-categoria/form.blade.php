<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('nombre', $eventosEspecialesPorCategoria->nombre, ['class' => 'form-control' . ($errors->has('nombre') ? ' is-invalid' : ''), 'placeholder' => 'Nombre','style' => 'width: 85%; border-radius: 50px; border-style: solid; border-width:4px; border-color: #DEE2E6; margin-bottom: 10px;']) }}
        ...
        <div class="form-group">
            ...
            data-style="btn-primary" title="Seleccionar Estado" required ">
                ...
                <option value="{{ $estado->id }}" {{ ($eventosEspecialesPorCategoria->id_estado ?? '') == $estado->id ? 'selected' : '' }}>
                            {{ $estado->nombre }}
    ...
    <div class="box-footer mt20">
        <button type="submit" class="btn btn-outline" href="{{ route('eventos-especiales-por-categorias.create') }}" class="btn btn-outline"
        style="color:#00324D; border:2px solid #82DEF0; height: 40px; width:120px; cursor: pointer; margin-left: 90%; border-radius: 35px; margin-top:15px; justify-content: center; justify-items: center; ">{{ __('GUARDAR') }}
