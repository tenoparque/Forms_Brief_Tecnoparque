<div class="container " style="margin-left:25px">
        ...
        <div class="d-flex" style="margin-top: 2%; margin-bottom: 2%">
            ...
            @if (Route::currentRouteName() === 'personalizaciones.edit')
                <div class="col-md-8" style="margin-bottom: 15px;">
                    ...
                    <div class=" contenedor-imgeditPerson">
        ...
        <div class="row " style="margin-top: 2%; margin-bottom: 2%">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                <label style="font-size: 18px; font-weight: bold; ">Color
                    principal</label>
                <input
                    style="border-radius:5px; border:1px solid #eaeaea;background:#fff; padding: calc(0.667* 16px) calc(2.667* 16px) calc(0.667* 16px) calc(0.667* 16px);"
                    id="color-picker-principal" name="color_principal"
            ...
            <div class="col-lg-4 col-md-12  col-sm-12 col-12">
                ...
                <input
                    style="border-radius:5px; border:1px solid #eaeaea;background:#fff; padding: calc(0.667* 16px) calc(2.667* 16px) calc(0.667* 16px) calc(0.667* 16px);"
                    id="color-picker-principal" id="color-picker-secundario" name="color_secundario"
            ...
            <div class=" col-lg-4 col-md-12 col-sm-12 col-12">
                ...
                <input
                    style="border-radius:5px; border:1px solid #eaeaea;background:#fff; padding: calc(0.667* 16px) calc(2.667* 16px) calc(0.667* 16px) calc(0.667* 16px);"
                    id="color-picker-principal" id="color-picker-terciario" name="color_terciario"
            ...
            <div class="col-lg-4 col-md-12  col-sm-12 col-12">
                ...
                <input
                    style="border-radius:5px; border:1px solid #eaeaea;background:#fff; padding: calc(0.667* 16px) calc(2.667* 16px) calc(0.667* 16px) calc(0.667* 16px);"
                    id="color-picker-principal" id="color-picker-cuarto" name="color_cuarto"
    ...
    <div class="box-footer mt20" style="text-align: right; margin-right:3%;">
        <button type="submit" class="btnGuardar" href="{{ route('personalizaciones.create') }}">{{ __('GUARDAR') }}
