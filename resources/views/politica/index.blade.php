                    ...
                    <div class="card-header">
                        <div style="d-flex justify-content-between align-items-center">
                            <div class="d-flex mt-3 mb-4">
                                <div>
                                    <h1 class="primeraPalabraFlex" style="margin-right: 0; font-size: 200%; font-weight: 900; color: rgb(0, 49, 77)"> {{ __('POLÍTICAS') }}</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="row mb-3">
                            <div class="col d-flex justify-content-between align-items-center search-Header">
                                <input class="form-control inputSearch" id="search" placeholder="Ingrese correo del usuario..." style="width: 70%; border-radius: 50px; border-style: solid; border-width:4px; border-color: #DEE2E6">
                                        ...
                                        <tr>
                                            ...
                                            <td id="buttoncell">
                                                <form action="{{ route('roles.destroy', $politica->id) }}" method="POST">
                                                    ...
                                                    <a class="btnEdit" href="{{ route('politicas.edit', $politica->id) }}">
