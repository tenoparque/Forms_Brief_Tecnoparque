                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12"
                                ...
                                <input type="checkbox" id="chkPassw" style="cursor: pointer;"> ¿Desea actualizar su
                                contraseña
                                actual?</input>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label id="lblPassw"
                                        style="font-size: 16px; display: none; color:black">Contraseña</label>
                                    <input type="password" id="txtPassw" name="txtPassw" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label id="lblCPassw" style="font-size: 16px; display: none; color:black">Confirmar
                                        contraseña</label>
                                    <input type="password" id="txtCPassw" class="form-control"
