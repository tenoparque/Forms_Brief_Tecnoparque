<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            data-style="btn-primary" title="Seleccionar un Tipo de Dato" required style="width: 85%; border-radius: 50px; border-style: solid; border-width:4px; border-color: #DEE2E6; margin-bottom: 10px;">
        ...
        <div class="form-group">
            ...
            data-style="btn-primary" title="Seleccionar un Tipo de Solicitud" required style="width: 85%; border-radius: 50px; border-style: solid; border-width:4px; border-color: #DEE2E6; margin-bottom: 10px;">
